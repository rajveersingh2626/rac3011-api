...
async function seedShowcaseDemoProjects(
  ...
  const specs: DemoProjectSpec[] = [
    {
      slug: 'demo-annual-mega-blood-drive',
      title: 'District Mega Blood Donation Drive 2026',
      category: 'Disease Prevention',
      date: '2026-08-24',
      summary: 'Multi-club mega blood donation drive collecting 1,200+ units across Delhi NCR.',
      body: 'Organized in partnership with Rotary Blood Bank and Red Cross Society across 8 simultaneous centers. Supported by over 120 student volunteers.',
      beneficiaries: 1200,
      photos: [
      ...
      status: 'published',
      leadClubId: lead,
      collaboratorClubIds: [otherA, otherB].filter((id): id is string => !!id),
    },
    {
      slug: 'demo-project-drishti-eyecare',
      title: 'Project Drishti: Cataract Screening & Surgery',
      category: 'Maternal & Child Health',
      date: '2026-08-15',
      summary: 'Comprehensive eye screening camps resulting in 650+ sponsored cataract surgeries.',
      body: 'Community health initiative reaching underserved rural areas around Gurgaon and South Delhi, ensuring post-operative care and free spectacles.',
      beneficiaries: 650,
      photos: [
      ...
      collaboratorClubIds: [otherC].filter((id): id is string => !!id),
    },
    {
      slug: 'demo-yamuna-restoration-cleanup',
      title: 'Yamuna River Bank Restoration & Clean-up',
      category: 'Environment',
      date: '2026-08-17',
      summary: 'Ecological revitalization effort removing 2.5 tons of plastic waste along the Yamuna.',
      body: 'Volunteers from 6 Rotaract clubs mobilized alongside local civic bodies to clean ghats, plant native wetland shrubs, and install educational boards.',
      beneficiaries: 2500,
      photos: [
    ...
    {
      slug: 'demo-stem-digital-literacy',
      title: 'STEM & Digital Literacy Lab Handover',
      category: 'Basic Education',
      date: '2026-08-19',
      summary: 'Refurbished 20-computer digital learning lab set up in a government secondary school.',
      body: 'Equipped with offline digital encyclopedia, coding kits, and teacher training sessions to bridge the digital divide for 450+ young learners.',
      beneficiaries: 450,
      photos: [
      ...
      collaboratorClubIds: [otherE].filter((id): id is string => !!id),
    },
    {
      slug: 'demo-career-bridge-conclave',
      title: 'Career Bridge: Mentorship & Corporate Conclave',
      category: 'Economic & Community Dev',
      date: '2026-09-01',
      summary: 'One-on-one resume reviews, mock interviews, and panels with top industry executives.',
      body: 'Over 800 college seniors and early-career Rotaractors participated in specialized tracks across Consulting, Tech, Finance, and Public Policy.',
      beneficiaries: 800,
      photos: [
      ...
      status: 'published',
      leadClubId: lead,
      collaboratorClubIds: [otherA, otherD].filter((id): id is string => !!id),
    },
    {
      slug: 'demo-clean-water-ro-plant',
      title: 'Clean Water for All: High-Capacity RO Plant',
      category: 'WASH',
      date: '2026-08-11',
      summary: 'Installed solar-assisted 500 LPH drinking water plant in a peri-urban community school.',
      body: 'Ensures safe potable drinking water for 1,200 students and neighborhood families, drastically decreasing waterborne illness incidence.',
      beneficiaries: 1200,
      photos: [
    ...
    {
      slug: 'demo-rotaract-cricket-league',
      title: 'Rotaract Cricket League (RCL 2026)',
      category: 'Peace & Conflict Resolution',
      date: '2026-08-29',
      summary: 'Premier annual inter-club sports tournament bringing together 32 clubs across Delhi NCR.',
      body: 'Promotes athletic camaraderie, mental wellbeing, and cross-zone collaboration with awards for best sportsmanship and fair play.',
      beneficiaries: 400,
      photos: [
        'https://images.unsplash.com/photo-1531415074868-036b1c5f53ec?auto=format&fit=crop&w=1200&q=80',
      ],
      status: 'published',
      leadClubId: lead,
      collaboratorClubIds: [otherB, otherC].filter((id): id is string => !!id),
    },
    {
      slug: 'demo-annapurna-zero-hunger',
      title: 'Project Annapurna: Zero Hunger Drive',
      category: 'Community Service',
      date: '2026-07-25',
      summary: 'Distribution of 3,000+ freshly cooked wholesome meals and dry ration kits.',
      body: 'Conducted around construction clusters and shelter homes with zero food wastage protocols in collaboration with local food rescue kitchens.',
      beneficiaries: 3000,
      photos: [
    ...
    {
      slug: 'demo-suvidha-menstrual-hygiene',
      title: 'Project Suvidha: Menstrual Health & Hygiene',
      category: 'Maternal & Child Health',
      date: '2026-08-08',
      summary: 'Distribution of 1,500 biodegradable sanitary kits and doctor-led awareness sessions.',
      body: 'Taboo-busting medical workshops conducted in 5 community schools by certified gynecologists, providing sustainable menstrual cups and pads.',
      beneficiaries: 1500,
      photos: [
    ...
    {
      slug: 'demo-sakhi-women-empowerment',
      title: 'Sakhi: Women Entrepreneurship & Skill Center',
      category: 'Economic & Community Dev',
      date: '2026-07-30',
      summary: 'Vocational training in sewing, handicrafts, and digital billing for 120 homemakers.',
      body: 'Graduating artisans receive sewing machines and market linkage support through district exhibitions, generating sustainable self-employment.',
      beneficiaries: 120,
      photos: [
        'https://images.unsplash.com/photo-1508830524289-0adcbe822b40?auto=format&fit=crop&w=1200&q=80',
      ],
      status: 'published',
      leadClubId: otherC ?? lead,
    },
    {
      slug: 'demo-little-hearts-cardiac',
      title: 'Little Hearts: Pediatric Cardiac Screening Camp',
      category: 'Disease Prevention',
      date: '2026-08-04',
      summary: 'Specialized 2D-echocardiogram checkups for 380 underprivileged children.',
      body: 'Identified 14 critical congenital heart defect cases and facilitated fully funded corrective surgical interventions via partner hospitals.',
      beneficiaries: 380,
      photos: [
        'https://images.unsplash.com/photo-1532938911079-1b06ac7ceec7?auto=format&fit=crop&w=1200&q=80',
      ],
      status: 'published',
      leadClubId: otherD ?? lead,
    },
    {
      slug: 'demo-harmony-interfaith-dialogue',
      title: 'Harmony Walk: Youth Peace & Unity Conclave',
      category: 'Peace & Conflict Resolution',
      date: '2026-08-14',
      summary: 'A peaceful youth march and inter-faith dialogue promoting communal harmony and empathy.',
      body: 'Gathered 600 college students from diverse backgrounds for panel deliberations on conflict resolution and civic responsibility.',
      beneficiaries: 600,
      photos: [
...
export async function seedDevData(
  ...
  await seedGalleryDemoData(ctx);
  log(`dev seed complete: ${DEV_ADMIN.email} / ${DEV_ADMIN.password}`);
}

async function seedGalleryDemoData(ctx: Ctx) {
  const items = [
    {
  ...
  for (const item of items) {
    const existing = await ctx.prisma.galleryItem.findFirst({
      where: { title: item.title },
    });
    if (existing) {
      await ctx.prisma.galleryItem.update({
        where: { id: existing.id },
        data: item,
      });
    } else {
      await ctx.prisma.galleryItem.create({
        data: item,
      });
    }
  }
