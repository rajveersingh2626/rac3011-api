...
export const passwordResetTemplate = defineTemplate({
  subject: () => 'Reset your Rotaract District Organisation password',
  body: (data) => ({
    heading: 'Reset your password',
    paragraphs: [
      `Hi ${str(data, 'name', 'there')},`,
      'We received a request to reset your password for the Rotaract District Organisation Portal. Click the button below to choose a new password.',
